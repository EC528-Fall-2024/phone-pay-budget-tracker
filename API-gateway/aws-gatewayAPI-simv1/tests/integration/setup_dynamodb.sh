...
seed_data "profileData" '{"pk": {"S": "naomi"}, "firstName": {"S": "Naomi"}, "lastName": {"S": "Gonzalez"}, "password": {"S": "test123"}, "profilePhoto": {"S": "https://www.oakdale"}, "username": {"S": "ngonz"}, "email": {"S": "ngonzalz@bu.edu"}, "accounts": {"S": ""}}'
